...
public enum AppError {
    ...
    ATTACHMENT_NOT_FOUND(HttpStatus.NOT_FOUND, ErrorCode.AT_404_001, "Attachment not found", "Not found attachment of %s for bizEvent with id %s, the receipt failure needs to be reviewed"),
