...
public enum AppError {
    ...
    BIZ_EVENT_NOT_FOUND_WITH_ORG_CF_AND_NAV_AND_DEBTOR_FISCAL_CODE(HttpStatus.NOT_FOUND, ErrorCode.BZ_404_004, BIZ_NOT_FOUND_HEADER, "Not found a biz event for the Organization Fiscal Code %s and NAV %s and Debtor Fiscal Code %s"),
