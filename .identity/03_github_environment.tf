...
locals {
  env_secrets = {
    ...
    "RECEIPT_COSMOS_DB_CONN_STRING" : "AccountEndpoint=https://pagopa-${var.env_short}-${local.location_short}-receipts-ds-cosmos-account.documents.azure.com:443/;AccountKey=${data.azurerm_cosmosdb_account.receipts_cosmos.primary_key};",
    "RECEIPTS_STORAGE_CONN_STRING" : data.azurerm_storage_account.receipts_sa.primary_connection_string,
    "SUBKEY" : data.azurerm_key_vault_secret.key_vault_integration_test_subkey.value,
    "TOKENIZER_API_KEY" : data.azurerm_key_vault_secret.key_vault_receipts_tokenizer_api_key.value,
    "SEARCH_TRANSACTION_TOKEN" : data.azurerm_key_vault_secret.key_vault_search_transactions_token_secret.value,
  }
  env_variables = {
